...
const { criarTarefa, listarTarefas, buscarTarefaPorId, atualizarTarefa, deletarTarefa, restaurarTarefa, listarTarefasDoProjeto } = require('../application/handler/tarefaHandler');
